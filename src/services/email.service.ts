...
export const sendAssignmentNotificationEmail = async (
  ...
  try {
    const adminLink = `${process.env.FRONTEND_URL}/admin/tickets/${ticketId}`;
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <p>
          <a href="${adminLink}" style="background-color: #2196F3; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block;">
            View Ticket
          </a>
        </p>
      `
